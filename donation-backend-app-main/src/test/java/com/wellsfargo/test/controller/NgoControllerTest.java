...
class NgoControllerTest {
	...
	private NgoDto createNgoDto() {
		...
		ngoDto.setId(1L);
		ngoDto.setNgoName("MEMO");
		ngoDto.setAddress("Pune");
		ngoDto.setUsername("Test1");
		ngoDto.setPassword("321123");
		ngoDto.setPhoneNumber(9883457891L);
		ngoDto.setStartedIn(LocalDate.of(2020, 05, 10));
		return ngoDto;
	}
